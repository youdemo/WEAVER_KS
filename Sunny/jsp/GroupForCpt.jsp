...
<%
	...
	url_1 = "/gvo/shaw/cpt/jsp/gvo_cptList_1.jsp";
	url_2 = "/gvo/shaw/cpt/jsp/gvo_cptList_2.jsp";
		...
		<div class="e8_boxhead">
			...
			<div class="e8_ultab">
				<div class="e8_navtab" id="e8_navtab">
					<span id="objName">我的IT资产</span>
				</div>
				<div>
		    <ul class="tab_menu">
		       	<li class="current">
					<a target="tabcontentframe" href="<%=url_1%>">待装<span id="allNum_span"></span></a>
				</li>
				<li class="">
